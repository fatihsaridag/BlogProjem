...
namespace BlogProjem.Services.Abstract
{
    public interface ICategoryService
    {
        ...
        Task<IDataResult<CategoryDto>> AddAsync(CategoryAddDto categoryAddDto, string createdByName);        //Veri eklediğimiz ve güncellediğimizde categoryDto dönüyor olacağız.
