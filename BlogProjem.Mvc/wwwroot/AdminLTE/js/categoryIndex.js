                    ...
                    if (isValid) {
                        ...
                        const newTableRow = `
                                <tr name=" ${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
                                    ...
                                    <td>${categoryAddAjaxModel.CategoryDto.Category.IsActive ? "Evet" : "Hayır"}</td>  @*  /*Eğer toString() yazmazsak bool formatında göndermiş oluyoruz.*/*@
                ...
                if (isValid) {                                                                         //Eğer bu değer true ise categoryUpdate işlemi gerçekleşmiş modelle ilgili bir sorun yok dmeekti.
                    ...
                    const newTableRow = `                                                                 
                                <tr name="${categoryUpdateAjaxModel.CategoryDto.Category.Id}">             
                                    ...
                                    <td>${categoryUpdateAjaxModel.CategoryDto.Category.IsActive ? "Evet" : "Hayır"}</td>  @*  /*Eğer toString() yazmazsak bool formatında göndermiş oluyoruz.*/*@
