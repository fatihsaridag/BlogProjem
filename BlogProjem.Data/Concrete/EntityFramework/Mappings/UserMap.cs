...
namespace BlogProjem.Data.Concrete.EntityFramework.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        ...
        private string CreatePasswordHash(User user , string password)      //Hash bilgisini eklememiz gerek bunun için bu methodu oluşturduk.
        {
            var passwordHasher = new PasswordHasher<User>();                //Identity ile gelen PasswordHasher sınıfı
